<section id="portfolio" class="pg pj vp mr oj wp nr">
    <!-- Section Title Start -->
    <div
        x-data="{ sectionTitle: `Delve into our portfolio`,
        sectionTitleText: `Witness our success stories, highlighting our proficiency in web development, mobile apps,
        and tailored solutions that deliver tangible results.`}"
    >
        ...
        <div class="projects-wrapper tc -ud-mx-5">
            ...
            <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
                <div class="c i pg sg z-1">
                    <img src="<?=base_url()?>/public/images/project-01.png" alt="Project" />
            ...
            <div class="project-item wi fb vd jn/2 to/3 digital">
                <div class="c i pg sg z-1">
                    <img src="<?=base_url()?>/public/images/project-02.png" alt="Project" />
            ...
            <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
                <div class="c i pg sg z-1">
                    <img src="<?=base_url()?>/public/images/project-04.png" alt="Project" />
            ...
            <div class="project-item wi fb vd vo/3 digital ecommerce">
                <div class="c i pg sg z-1">
                    <img src="<?=base_url()?>/public/images/project-03.png" alt="Project" />
