...
>
    <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
        <div class="vd to/4 tc wf yf">
            <a href="">
                <img class="om" src="<?= base_url() ?>/public/images/logo/logo-light.svg" alt="Logo Light"/>
                <img class="xc nm" src="<?= base_url() ?>/public/images/logo/logo-dark.svg" alt="Logo Dark"/>
            </a>
        ...
        <div
            ...
            <nav>
                <ul class="tc _o sf yo cg ep">
                    <li><a id="nav-home" href="#" class="xl">Home</a></li>
                    <li><a id="nav-about-us" href="#about-us" class="xl">About Us</a></li>
                    <li><a id="nav-services" href="#services" class="xl">Services</a></li>
                    <li><a id="nav-contact-us" href="#contact-us" class="xl">Contact Us</a></li>
                    <li><a id="nav-portfolio" href="#portfolio" class="xl">Portfolio</a></li>
                    <li><a id="" href="<?=base_url()?>courses" class="xl">Courses</a></li>
                </ul>
            </nav>
            ...
            <div class="tc wf ig pb no">
                <div class="pc h io pa ra" :class="navigationOpen ? '!-ud-visible' : 'd'">
                    <label class="rc ab i">
                        ...
                        <!-- Icon Sun -->
                        <img class="xc nm" src="<?= base_url() ?>/public/images/icon-moon.svg" alt="Moon"/>
                    </label>
                </div>

<!--                <a href="#" :class="{ 'nk yl' : page === 'home', 'ok' : page === 'home' && stickyMenu }"-->
<!--                   class="ek pk xl">Sign In</a>-->
<!--                <a href="#" :class="{ 'hh/[0.15]' : page === 'home', 'sh' : page === 'home' && stickyMenu }"-->
