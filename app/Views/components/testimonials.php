<section id="testimonials" class="hj rp hr">
    <!-- Section Title Start -->
    <div
                    ...
                    <div class="swiper-slide">
                        <div class="i hh rm sg vk xm bi qj">
                            ...
                            <div class="tc sf rn tn un zf dp">
                                <img class="bf" src="<?= base_url() ?>/public/images/testimonial.png" alt="User"/>

                                <div>
                                    <img src="<?= base_url() ?>/public/images/icon-quote.svg" alt="Quote"/>
                                    ...
                                    <div class="tc yf vf">
                                        ...
                                        <img class="rk" src="<?= base_url() ?>/public/images/brand-light-02.svg"
                                             alt="Brand"/>
                                    </div>
                                </div>
                            </div>
