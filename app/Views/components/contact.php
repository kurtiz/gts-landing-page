<section id="contact-us" class="i pg fh rm ji gp uq">
    <!-- Bg Shapes -->
    <img src="<?= base_url() ?>/public/images/shape-06.svg" alt="Shape" class="h aa y"/>
    <img src="<?= base_url() ?>/public/images/shape-03.svg" alt="Shape" class="h ca u"/>
    <img src="<?= base_url() ?>/public/images/shape-07.svg" alt="Shape" class="h w da ee"/>
    <img src="<?= base_url() ?>/public/images/shape-12.svg" alt="Shape" class="h p s"/>
    <img src="<?= base_url() ?>/public/images/shape-13.svg" alt="Shape" class="h r q"/>
    ...
    <div class="i va bb ye ki xn wq jb mo">
        <div class="tc uf sn tf rn un zf xl:gap-10">
            <div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
                <!-- Bg Shapes -->
                <img src="<?= base_url() ?>/public/images/shape-03.svg" alt="Shape" class="h la x wd"/>
                <img src="<?= base_url() ?>/public/images/shape-06.svg" alt="Shape" class="h la ma ne kf"/>

                <div class="fb">
                    <h4 class="wj kk wm cc">Email Address</h4>
                    <p><a href="mailto:gtsworkspace@gmail.com">gtsworkspace@gmail.com </a></p>
                </div>
                <div class="fb">
                ...
                <div>
                    ...
                    <ul class="tc wf fg">
                        <li>
                            <a href="https://www.facebook.com/GideonsTechnologicalSolutions?mibextid=ZbWKwL"
                               class="c tc wf xf ie ld rg ml il tl" target="_blank">
                        ...
                        <li>
                            <a href="https://www.twitter.com/gtsolutionsgh"
                               class="c tc wf xf ie ld rg ml il tl" target="_blank">
                        ...
                        <li>
                            <a href="https://www.linkedin.com/company/gtsolutions-gts/" target="_blank"
