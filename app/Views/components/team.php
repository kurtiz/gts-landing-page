<section class="i pg ji gp uq">
    ...
    <img src="<?= base_url() ?>/public/images/shape-08.svg" alt="Shape Bg" class="h q r"/>
    <img src="<?= base_url() ?>/public/images/shape-09.svg" alt="Shape" class="of h y z/2"/>
    <img src="<?= base_url() ?>/public/images/shape-10.svg" alt="Shape" class="h _ aa"/>
    <img src="<?= base_url() ?>/public/images/shape-11.svg" alt="Shape" class="of h m ba"/>
        ...
        <div class="wc qf pn xo gg cp">
            ...
            <div class="animate_top rj">
                <div class="c i pg z-1">
                    <img class="vd" src="<?= base_url() ?>/public/images/team-01.png" alt="Team"/>
            ...
            <div class="animate_top rj">
                <div class="c i pg z-1">
                    <img class="vd" src="<?= base_url() ?>/public/images/team-02.png" alt="Team"/>
            ...
            <div class="animate_top rj">
                <div class="c i pg z-1">
                    <img class="vd" src="<?= base_url() ?>/public/images/team-03.png" alt="Team"/>
