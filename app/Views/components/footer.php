<footer>
    <div class="bb ze ki xn 2xl:ud-px-0">
        ...
        <div class="ji gp">
            <div class="tc uf ap gg fp">
                <div class="animate_top zd/2 to/4">
                    <a href="index.html">
                        <img src="<?= base_url() ?>/public/images/logo/logo-light.svg" alt="Logo" class="om"/>
                        <img src="<?= base_url() ?>/public/images/logo/logo-dark.svg" alt="Logo" class="xc nm"/>
                    </a>

                    <p class="lc fb">Technology.Digital.Advertising</p>
                ...
                <div class="vd ro tc sf rn un gg vn">
                    <div class="animate_top">
                        ...
                        <ul>
                            <li><a href="<?=base_url()?>" class="sc xl vb">Home</a></li>
                            <li><a href="<?=base_url()?>#about-us" class="sc xl vb">About Us</a></li>
                            <li><a href="<?=base_url()?>#services" class="sc xl vb">Services</a></li>
                            <li><a href="<?=base_url()?>#portfolio" class="sc xl vb">Portfolio</a></li>
                            <li><a href="javascript:void(0)" class="sc xl vb">Courses</a></li>
                            <?php
                            /*<li>
                    ...
                    <div class="animate_top">
                        ...
                        <ul>
                            ...
                            <li><a href="#" class="sc xl vb">App Development</a></li>
                            <li><a href="#" class="sc xl vb">GTS Prints</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="animate_top">
                        ...
                        <ul>
                            ...
                            */
                            ?>
                            <li><a href="<?=base_url()?>#contact-us" class="sc xl vb">Contact Us</a></li>
                        </ul>
                    </div>
                    <?php /*
                    <div class="animate_top">
        ...
        <div class="bh ch pm tc uf sf yo wf xf ap cg fp bj">
            ...
            <div class="animate_top">
                <p>&copy; <?=date("Y")?> GT Solutions. All rights reserved</p>
            </div>
        </div>
        <!-- Footer Bottom -->
    </div>
